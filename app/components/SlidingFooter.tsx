...
export default function SlidingFooter() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-0 left-0 right-0 z-30 bg-[#1A1A1A] shadow-2xl transition-transform duration-300 ease-in-out md:hidden ${
        ...
        <div className="overflow-y-auto h-full pb-20">
          <div className="p-6">
            ...
            <nav className="space-y-4">
              <a
                href="/"
                className="block py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-medium text-white">Properties</span>
                </div>
              </a>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-medium text-white">Call Us</span>
                </div>
              </a>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-medium text-white">Email Us</span>
                </div>
              </a>
